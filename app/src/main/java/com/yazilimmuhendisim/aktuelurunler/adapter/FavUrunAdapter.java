...
import com.yazilimmuhendisim.aktuelurunler.ui.FavUrunlerFragment;
...
public class FavUrunAdapter extends RecyclerView.Adapter<FavUrunAdapter.CardViewTasarimTutucu1>{
    private Context context;
    private List<Urun> urunList;
    private VeritabaniYardimcisi vt;

    public FavUrunAdapter(Context context, List<Urun> urunList){
        this.context=context;
        this.urunList=urunList;
        vt = new VeritabaniYardimcisi(context);
    }

    public class CardViewTasarimTutucu1 extends RecyclerView.ViewHolder{
        ...
        public CardViewTasarimTutucu1(@NonNull View itemView) {
            super(itemView);
    ...
    @NonNull
    @Override
    public CardViewTasarimTutucu1 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.tum_urun_card_tasarim,parent,false);
        return new CardViewTasarimTutucu1(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final CardViewTasarimTutucu1 holder,final int position) {
        ...
        holder.fav_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(new FavUrunlerDAO(context).urunFavmi(vt,urun.getId())){
                    ...
                    FavUrunlerFragment.favUrunSilindi();
